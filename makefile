...
build: obj/ obj/app.o obj/fmatrix.o obj/ftree.o
...
obj/ftree.o:		src/core/ftree.cpp src/core/ftree.hpp obj/fnode.o
	$(CC) -c -fPIC	src/core/ftree.cpp -o obj/ftree.o

obj/fnode.o:		src/core/fnode.cpp src/core/fnode.hpp obj/fobject.o
	$(CC) -c -fPIC	src/core/fnode.cpp -o obj/fnode.o

obj/fmatrix.o:		src/core/fmatrix.cpp src/core/fmatrix.hpp obj/fobject.o
